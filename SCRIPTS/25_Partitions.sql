...
-- MySQL handles file management automatically, so Step 2, 3, and 4 are combined here.
...
PARTITION BY RANGE COLUMNS(OrderDate) (
    -- VALUES LESS THAN '2024-01-01' includes everything up to '2023-12-31'
...
INSERT INTO Orders_Partitioned VALUES (2, '2024-07-20', 50);
INSERT INTO Orders_Partitioned VALUES (3, '2025-12-31', 20);
INSERT INTO Orders_Partitioned VALUES (4, '2026-01-01', 100);
...
-- In MySQL, use EXPLAIN to see "Partition Pruning"
EXPLAIN SELECT * 
